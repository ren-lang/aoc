...
*/ var _Scheduler_working = false;
    ...
    var $author$project$Main$addStdlib = function(_v0) {
        ...
        return {
            ...
            imports: _Utils_ap(imports, A2($elm$core$List$filter, function(imprt) {
                return !A2($elm$core$List$member, imprt, imports);
            }, stdlib))
        };
    };
...
const $503e9ca78180412c$var$compiler = $c77fd59d8c5b2ad5$exports.Elm.Main.init({
    flags: {
